...
import { claimBuyerEpochRewards, claimEpochRewards, claimPoolRewards, previewPoolRewards, RewardClaimProgress } from '../reward-actions.js';
...
function poolFixture(closedAtEpoch = 0) {
  ...
  const rewards = {
    previewStakerReward: async () => wasClaimed ? 0n : 12n,
