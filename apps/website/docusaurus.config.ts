...
const config: Config = {
  ...
  themeConfig: {
    metadata: [
      ...
      {name: 'keywords', content: 'AI marketplace, buy AI services, sell AI services, peer-to-peer AI, decentralized AI inference, decentralized AI routing, OpenRouter alternative, OpenAI-compatible API, OpenAI-compatible P2P AI network, anonymous AI, private AI, P2P AI, AI economy'},
      {name: 'description', content: 'AntSeed is an OpenAI-compatible P2P AI network and OpenRouter alternative. Buy, sell, and build AI services with decentralized AI routing, privacy, and no middleman.'},
      {property: 'og:title', content: 'AntSeed — The Unstoppable AI Economy'},
      {property: 'og:description', content: 'AntSeed is an OpenAI-compatible P2P AI network and OpenRouter alternative with decentralized AI routing, privacy, and no middleman.'},
      ...
      {name: 'twitter:description', content: 'AntSeed is an OpenAI-compatible P2P AI network and OpenRouter alternative with decentralized AI routing, privacy, and no middleman.'},
    ],
    colorMode: {
      defaultMode: 'light',
      disableSwitch: true,
