            ...
            <InfoTooltip
              ...
              content={(
                <>
                  ...
                  <span>Trust = settled service history (up to 60) + last epoch usage share (up to 15) + this epoch power share (up to 5) + verified identity (up to 20); proven wash traders score 0.</span>
                </>
              )}
            >
