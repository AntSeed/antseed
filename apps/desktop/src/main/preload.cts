...
const api = {
  ...
  chatGenerateImage(payload: { conversationId: string; prompt: string; peerId?: string; safeMode?: boolean; service: string; sourceImageAttachmentId?: string }): Promise<{ ok: boolean; user?: unknown; assistant?: unknown; error?: string }> {
