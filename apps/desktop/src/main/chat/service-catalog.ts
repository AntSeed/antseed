...
export type ChatServiceProtocol = Exclude<CatalogServiceProtocol, 'openai-images' | 'typesafe-systemone' | 'antseed-routing'>;
...
function normalizeCapabilities(value: unknown): CatalogServiceCapabilities | undefined {
  ...
  if (reasoningEfforts !== undefined) capabilities.reasoningEfforts = reasoningEfforts;
