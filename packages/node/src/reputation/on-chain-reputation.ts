...
export const ON_CHAIN_VERIFICATION_DOMAIN_POINTS = 35;
export const ON_CHAIN_VERIFICATION_GITHUB_POINTS = 10;
export const ON_CHAIN_VERIFICATION_MAX_POINTS = 45;
