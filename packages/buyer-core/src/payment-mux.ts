...
import type { FramedMessage } from '@antseed/protocol/messages';
import * as codec from '@antseed/protocol/payment-codec';
...
export class PaymentMux {
  ...
  constructor(connection: BuyerConnection) {
