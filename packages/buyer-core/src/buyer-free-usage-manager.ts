...
import type { FreeUsageAckPayload, NeedFreeUsageAuthPayload } from '@antseed/protocol/messages';
...
export class BuyerFreeUsageManager {
  ...
  async prepareOpen(peer: BuyerPeerView, paymentMux: PaymentMux): Promise<void> {
