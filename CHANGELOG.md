...
- Contracts: added a one-shot historical SP1 wash-trading registry that pins one approved report manifest and records the complete seller-level proven wash volume snapshot without implementing historical claims or ongoing epoch penalties.
- Contracts: added an Anvil E2E that submits the complete 26-claim, manifest-bound development aggregate through a digest-pinned development verifier.
