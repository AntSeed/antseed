...
- Fixed unmatched image billing tiers silently evaluating to zero. Sellers now reject requests they cannot price before forwarding them upstream instead of serving paid image work for free.
