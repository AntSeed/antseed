...
- Contracts: added a standalone, versioned SP1 aggregate wash-trading registry that records proven wash and total volume onchain and blocks future seller points for the remainder of the acceptance epoch plus eight full epochs, without changing historical reward claims.
