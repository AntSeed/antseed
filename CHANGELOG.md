...
- Added registry-only model verification shadow mode: approved verifiers can anchor evidence bundles and seller/service verdicts on-chain, while verifier reward accounting, emissions allocation, and claims remain intentionally deferred to a separate future contract.
