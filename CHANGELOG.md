...
- Desktop Add credits now offers Peer Pay as a hosted bank/payment-app deposit method with a directly editable amount and destination-wallet-signed checkout requests.
